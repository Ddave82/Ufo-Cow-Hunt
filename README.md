...
A small 3D browser game built with Three.js: fly a UFO across a moonlit farm landscape, find cows, and abduct them with your light beam. Between radar sweeps, farm drones, synth music, and sci-fi sound effects, the goal is to clear three cow-hunting waves as smoothly as possible.
...
The mission is split into three waves in the same level:

- Wave 1: abduct 10 cows
- Wave 2: abduct 15 cows
- Wave 3: abduct 20 cows
...
- Wave-specific cow behavior: boost scares cows from Wave 2 onward, and targets wander slowly in Wave 3
...
- Start menu, settings menu, and mission-complete screen with return to main menu
